package dev.eblanvisuals.client.render.msdf;
...
import dev.eblanvisuals.client.render.msdf.FontData.AtlasData;
import dev.eblanvisuals.client.render.msdf.FontData.GlyphData;
import dev.eblanvisuals.client.render.msdf.FontData.MetricsData;
import dev.eblanvisuals.client.render.providers.ResourceProvider;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public Builder data(String dataFileName) {
			this.dataIdentifer = EblanVisuals.id("fonts/" + dataFileName + ".json");
			return this;
		}

		public Builder atlas(String atlasFileName) {
			this.atlasIdentifier = EblanVisuals.id("fonts/" + atlasFileName + ".png");
			return this;
		}

		public MsdfFont build() {
			dev.eblanvisuals.client.render.msdf.FontData data = ResourceProvider.fromJsonToInstance(this.dataIdentifer, FontData.class);
