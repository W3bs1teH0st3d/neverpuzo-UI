package dev.eblanvisuals.client.ui.clickgui.components.impl;
...
public class ModuleComponent extends Component {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (hovered && mc.currentScreen instanceof dev.eblanvisuals.client.ui.clickgui.ClickGui clickGui) {
