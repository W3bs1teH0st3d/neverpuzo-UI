...
import dev.eblanvisuals.client.managers.ConfigManager;
...
public class ConfigAliasCommand extends Command {
    ...
    private void saveConfig(String configName) {
        ...
        ConfigManager configManager = EblanVisuals.getInstance().getConfigManager();
    ...
    private void suggestConfigs(SuggestionsBuilder suggestionsBuilder) {
        String[] configs = EblanVisuals.getInstance().getConfigManager().getConfigList();
